...
struct NotificationsView: View {
    ...
    /// Called when user taps a COMMENT notification
    ...
    private func handleTap(_ notification: AppNotification) {
        ...
        // Small delay to let the sheet fully dismiss before pushing navigation
        // on the underlying NavigationStack (300ms is sufficient on all devices).
        Task {
